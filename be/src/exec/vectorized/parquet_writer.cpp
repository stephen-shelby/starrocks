...
namespace starrocks::vectorized {
    ...
    Status ParquetWriterWrap::new_file_writer() {
        ...
        _writer = std::make_shared<starrocks::parquet::FileWriter>(std::move(writable_file), file_name, _partition_dir, _properties, _schema, _output_expr_ctxs, _parent_profile);
